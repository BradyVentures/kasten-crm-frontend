...
export default function MobileHeader({ onMenuToggle }: MobileHeaderProps) {
  return (
    <header className="md:hidden sticky top-0 z-40 bg-bd-card border-b border-bd-border px-4 py-3 flex items-center justify-between">
      <div>
      ...
      <button
        ...
        className="w-11 h-11 flex items-center justify-center rounded-lg hover:bg-bd-card-hover transition-colors"
        aria-label="Menü"
      >
